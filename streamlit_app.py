...
spreadsheet = gc.open_by_url("https://docs.google.com/spreadsheets/d/1mZymnpQ1l-lEqiwDnursBKN0Mh69L5GziXFyyM5nUI0/edit")
sheet = spreadsheet.sheet1  # Modify if your sheet has a custom name

# Test writing to and reading from the sheet
sheet.update("A1", "Test successful")
val = sheet.acell("A1").value
st.write("Cell A1 value:", val)
