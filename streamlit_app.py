...
sheet = gc.open_by_url("https://docs.google.com/spreadsheets/d/10j8gkxcrBc8vCi3nWkLPnx9Bab4mhj-Gu91Pss3QLoQ/edit").sheet1

def write_to_sheet(place_id, text):
...
def process_place(place, loc):
    ...
    try:
        ...
        if matched:
            ...
            write_to_sheet(pid, text)  # <── Writing to Google Sheet
